<template>
  <div class="page-container">
    <CrudTable :data="tableData" :loading="loading" :total="total" @add="ElMessage.info('创建SEO发布任务')" @refresh="loadData" @search="handleSearch" @delete="handleDelete">
      <el-table-column prop="id" label="序号" width="80" sortable align="center" />
      <el-table-column prop="name" label="任务名称" min-width="200" />
      <el-table-column prop="site" label="目标站点" width="200" />
